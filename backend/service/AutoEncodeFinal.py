...
print("Loading model...")
model = keras.models.load_model('../../Model/AutoEncoder/Final.h5', compile=False)
preprocessor = SequencePreprocessor.load('../../Model/AutoEncoder/preprocessor.pkl')
threshold = 2.62
...
test_data = pd.read_csv('../../Model/Beta dataset/labelled_testing_data.csv')
...
if anomaly_count > 0:
    ...
    results.head(2).to_csv('top_2_critical.csv', index=False)
    print(f"✅ Top 2 critical saved to: top_2_critical.csv")
    print("="*80)
else:
